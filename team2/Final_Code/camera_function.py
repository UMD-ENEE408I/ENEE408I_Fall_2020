...
# import the global serial object from run_robot
...
obama_image = face_recognition.load_image_file("human_picture/obama.jpg")
obama_face_encoding = face_recognition.face_encodings(obama_image)[0]

biden_image = face_recognition.load_image_file("human_picture/biden.jpg")
biden_face_encoding = face_recognition.face_encodings(biden_image)[0]

Yuchen_image = face_recognition.load_image_file("human_picture/Yuchen_00000.jpg")
Yuchen_face_encoding = face_recognition.face_encodings(Yuchen_image)[0]

Amy_image = face_recognition.load_image_file("human_picture/Amy Hizoune.jpg")
...
def is_center(x_coordinate):
    if x_coordinate > 350 or x_coordinate < 150:
        return False
    else:
        return True
        ...
        # Convert the image from BGR color (which OpenCV uses) to RGB color (which face_recognition uses)
            ...
            if not len(results):
                ...
                for r in results:
                    ...
                    print("distance:  " + str(2148.2*average_bound_length**-1.02) +" cm")
                    cv2.putText(small_frame, "distance:  " + str((round(2148.2*average_bound_length**-1.02))) +" cm", (540,480), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)
